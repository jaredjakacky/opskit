...
func TestErrorSentinels(t *testing.T) {
	tests := []struct {
		...
		{name: "component panicked", err: ErrComponentPanicked, want: "opskit: component operation panicked"},
		...
		{name: "check describer unsupported", err: ErrCheckDescriberUnsupported, want: "opskit: component does not describe checks"},
